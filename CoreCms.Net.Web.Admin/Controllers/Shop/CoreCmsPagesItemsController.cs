...
namespace CoreCms.Net.Web.Admin.Controllers
{
    ...
    public class CoreCmsPagesItemsController : Controller
    {
        ...
        [HttpPost]
        [Description("创建提交")]
        public async Task<JsonResult> DoCreate([FromBody] CoreCmsPagesItems entity)
        {
            var jm = new AdminUiCallBack();
        ...
        [HttpPost]
        [Description("编辑提交")]
        public async Task<JsonResult> DoEdit([FromBody] CoreCmsPagesItems entity)
        {
            var jm = new AdminUiCallBack();
