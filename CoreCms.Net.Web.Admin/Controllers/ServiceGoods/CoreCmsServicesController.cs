...
namespace CoreCms.Net.Web.Admin.Controllers
{
    ...
    public class CoreCmsServicesController : Controller
    {
        ...
        [HttpPost]
        [Description("创建提交")]
        public async Task<JsonResult> DoCreate([FromBody] CoreCmsServices entity)
        {
            var jm = new AdminUiCallBack();
        ...
        [HttpPost]
        [Description("编辑提交")]
        public async Task<JsonResult> DoEdit([FromBody] CoreCmsServices entity)
        {
            var jm = new AdminUiCallBack();
