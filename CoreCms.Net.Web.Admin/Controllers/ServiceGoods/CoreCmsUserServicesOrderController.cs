...
namespace CoreCms.Net.Web.Admin.Controllers
{
    ...
    public class CoreCmsUserServicesOrderController : ControllerBase
    {
        ...
        [HttpPost]
        [Description("创建提交")]
        public async Task<AdminUiCallBack> DoCreate([FromBody] CoreCmsUserServicesOrder entity)
        {
            var jm = new AdminUiCallBack();
        ...
        [HttpPost]
        [Description("编辑提交")]
        public async Task<AdminUiCallBack> DoEdit([FromBody] CoreCmsUserServicesOrder entity)
        {
            var jm = new AdminUiCallBack();
