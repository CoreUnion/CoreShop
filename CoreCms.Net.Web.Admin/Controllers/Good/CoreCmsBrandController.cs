...
namespace CoreCms.Net.Web.Admin.Controllers
{
    ...
    [Authorize]
    public class CoreCmsBrandController : Controller
    {
        ...
        [HttpPost]
        [Description("创建提交")]
        public async Task<JsonResult> DoCreate([FromBody] CoreCmsBrand entity)
        {
            var jm = new AdminUiCallBack();
        ...
        [HttpPost]
        [Description("编辑提交")]
        public async Task<JsonResult> DoEdit([FromBody] CoreCmsBrand entity)
        {
            var jm = new AdminUiCallBack();
