...
namespace CoreCms.Net.Web.Admin.Controllers
{
    ...
    public class CoreCmsSolitaireItemsController : Controller
    {
        ...
        [HttpPost]
        [Description("创建提交")]
        public async Task<JsonResult> DoCreate([FromBody] CoreCmsSolitaireItems entity)
        {
        ...
        [HttpPost]
        [Description("编辑提交")]
        public async Task<JsonResult> DoEdit([FromBody] CoreCmsSolitaireItems entity)
        {
