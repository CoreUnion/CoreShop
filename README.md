...
#### 💐 核心商城（CoreShop）介绍
> 核心商城系统`（CoreShop）` 是基于 Asp.Net 9.0、Uni-App开发、支持可视化布局的小程序商城系统；前后端分离，支持跨平台运行；拥有分销、代理、团购秒杀、接龙、拼团、直播、优惠券、自定义表单等众多营销功能，拥有完整SKU、下单、售后、物流流程，支持可视化自定义首页模块布局效果。    
...
- 如果有需要专业版源代码及技术服务指导的，请前往【[https://www.coreshop.cn/Service/Subscription](https://www.coreshop.cn)】购买订阅服务。
