<!-- 分销排行 -->
<template>
    <view class="rankings-wrap bg-blue">
        <!-- 标题栏 -->
        <view class="nav-box">
            <cu-custom isBack>
                <block slot="backText">代理排行</block>
            </cu-custom>
        </view>
    ...
    export default {
        ...
        methods: {
            getRankings() {
                ...
                this.$u.api.getAgentRanking().then(res => {
                    if (res.code === 0) {
...
<style lang="scss">
    .rankings-wrap { background-image: url('/static/images/common/bg.png'); background-size: cover; background-position: center; height: 100%; overflow: hidden; min-height: 100vh; }
