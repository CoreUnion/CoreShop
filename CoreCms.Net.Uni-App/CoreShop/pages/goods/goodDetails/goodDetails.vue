    ...
    <view>
        ...
        <view class="coreshop-bg-white coreshop-common-view-box coreshop-good-title-view-box">
            <view class="title-view">
                ...
                <text class="coreshop-text-black u-font-lg coreshop-text-bold">{{ product.name || '' }}</text>
            </view>
        ...
        <!--促销-->
        <view class="u-margin-top-20 coreshop-bg-white coreshop-common-view-box" v-if="promotion.length > 0" @tap="promotionTap">
                            ...
                            <view class="coreshop-list-item">
                                ...
                                <view class="content">
                                    ...
                                    <view class="coreshop-text-black u-font-sm flex">
                                        <view class="u-line-1">已选: {{ product.spesDesc || product.name}}  库存：{{product.stock > 0 ? product.stock :0 }}</view>
                                    </view>
                                </view>
                            </view>
                        </view>
