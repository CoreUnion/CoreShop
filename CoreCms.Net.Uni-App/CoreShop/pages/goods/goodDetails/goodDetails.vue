    ...
    <view>
        ...
        <view class="bg-white coreshop-view-box coreshop-title-view-box">
            <view class="title-view">
                ...
                <text class="text-black text-lg text-bold">{{ product.name || '' }}</text>
            </view>
            <view class="light bg-red radius margin-top-sm coreshop-title-tip-box">
                <view>
                    <!--<text class="u-margin-right-20" v-if="goodsInfo.brand">{{ goodsInfo.brand.name}}</text>-->
        ...
        <view class="margin-top bg-white coreshop-view-box coreshop-select-view-box">
            ...
            <view class="flex flex-wrap text-sm" @tap="selectTap(0)" v-if="isSpes">
                <view class="basis-1">
        ...
        <view class="coreshop-footer-fixed">
            <view class="cu-bar bg-white tabbar border shop">
                ...
                <!-- #ifdef MP-ALIPAY -->
                <view class="action">
                    <contact-button class="goods-bottom-ic icon" icon="/static/images/customerservice.png" size="80rpx*80rpx" tnt-inst-id="WKPKUZXG"
                ...
                <view class="btn-group">
                    <button class="cu-btn bg-orange radius shadow-blur" @tap="selectTap(1)">加入购物车</button>
                    <button class="cu-btn bg-red radius shadow-blur" @tap="selectTap(2)">立即购买</button>
                </view>
            </view>
        </view>
