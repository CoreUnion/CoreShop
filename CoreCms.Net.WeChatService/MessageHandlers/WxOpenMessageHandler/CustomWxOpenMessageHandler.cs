...
namespace CoreCms.Net.WeChatService.WxOpenMessageHandler
{
    /// <summary>
    /// 自定义MessageHandler
    ...
    {
        private string appId = Senparc.Weixin.Config.SenparcWeixinSetting.WxOpenAppId;
        ...
        public override IResponseMessageBase OnTextRequest(RequestMessageText requestMessage)
        {
            ...
            {
                //上传封面临时素材
                var uploadResult = Senparc.Weixin.MP.AdvancedAPIs.MediaApi.UploadTemporaryMedia(appId, Senparc.Weixin.MP.UploadMediaFileType.image, ServerUtility.ContentRootMapPath("~/Images/Logo.thumb.jpg"));
