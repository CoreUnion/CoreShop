...
using CoreCms.Net.WeChatService.OpenTicket;
using CoreCms.Net.WeChatService.Utilities;
#else
using CoreCms.Net.WeChatService.CustomMessageHandler;
using CoreCms.Net.WeChatService.OpenTicket;
using CoreCms.Net.WeChatService.Utilities;
...
namespace CoreCms.Net.WeChatService.MessageHandlers.OpenMessageHandler
{
    /// <summary>
    /// 开放平台全网发布之前需要做的验证
    /// </summary>
        ...
        */
        ...
        public override IResponseMessageBase OnTextRequest(RequestMessageText requestMessage)
        {
            ...
            if (requestMessage.Content.StartsWith("QUERY_AUTH_CODE:"))
            {
                ...
                {
                    Senparc.Weixin.WeixinTrace.SendCustomLog("OnTextRequest过程错误", ex.Message);
                    throw;
                }
            }
            return null;
